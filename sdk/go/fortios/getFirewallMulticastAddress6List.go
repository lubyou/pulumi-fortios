...
func (o GetFirewallMulticastAddress6ListResultOutput) ToOutput(ctx context.Context) pulumix.Output[GetFirewallMulticastAddress6ListResult] {
	return pulumix.Output[GetFirewallMulticastAddress6ListResult]{
