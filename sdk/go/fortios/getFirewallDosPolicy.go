...
func (o LookupFirewallDosPolicyResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupFirewallDosPolicyResult] {
	return pulumix.Output[LookupFirewallDosPolicyResult]{
