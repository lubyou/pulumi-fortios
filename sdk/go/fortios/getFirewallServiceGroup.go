...
func (o LookupFirewallServiceGroupResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupFirewallServiceGroupResult] {
	return pulumix.Output[LookupFirewallServiceGroupResult]{
