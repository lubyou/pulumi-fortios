...
func (o LookupRouterKeyChainResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupRouterKeyChainResult] {
	return pulumix.Output[LookupRouterKeyChainResult]{
