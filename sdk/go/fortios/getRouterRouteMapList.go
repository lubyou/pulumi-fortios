...
func (o GetRouterRouteMapListResultOutput) ToOutput(ctx context.Context) pulumix.Output[GetRouterRouteMapListResult] {
	return pulumix.Output[GetRouterRouteMapListResult]{
