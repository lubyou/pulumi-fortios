...
func (o LookupFirewallPolicy6ResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupFirewallPolicy6Result] {
	return pulumix.Output[LookupFirewallPolicy6Result]{
