...
func (o FirewallRegionOutput) GetAllTables() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FirewallRegion) pulumi.StringPtrOutput { return v.GetAllTables }).(pulumi.StringPtrOutput)
}
