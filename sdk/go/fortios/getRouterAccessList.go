...
func (o LookupRouterAccessListResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupRouterAccessListResult] {
	return pulumix.Output[LookupRouterAccessListResult]{
