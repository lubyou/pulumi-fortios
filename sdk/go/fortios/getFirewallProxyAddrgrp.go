...
func (o LookupFirewallProxyAddrgrpResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupFirewallProxyAddrgrpResult] {
	return pulumix.Output[LookupFirewallProxyAddrgrpResult]{
