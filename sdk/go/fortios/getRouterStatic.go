...
func (o LookupRouterStaticResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupRouterStaticResult] {
	return pulumix.Output[LookupRouterStaticResult]{
