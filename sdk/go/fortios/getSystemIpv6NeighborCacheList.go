...
func (o GetSystemIpv6NeighborCacheListResultOutput) ToOutput(ctx context.Context) pulumix.Output[GetSystemIpv6NeighborCacheListResult] {
	return pulumix.Output[GetSystemIpv6NeighborCacheListResult]{
