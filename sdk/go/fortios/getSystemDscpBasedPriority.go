...
func (o LookupSystemDscpBasedPriorityResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupSystemDscpBasedPriorityResult] {
	return pulumix.Output[LookupSystemDscpBasedPriorityResult]{
