...
func (o LookupFirewallProxyAddressResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupFirewallProxyAddressResult] {
	return pulumix.Output[LookupFirewallProxyAddressResult]{
