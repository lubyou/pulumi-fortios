...
func (o LookupFirewallAddress6ListResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupFirewallAddress6ListResult] {
	return pulumix.Output[LookupFirewallAddress6ListResult]{
