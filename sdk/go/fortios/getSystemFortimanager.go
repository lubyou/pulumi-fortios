...
func (o LookupSystemFortimanagerResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupSystemFortimanagerResult] {
	return pulumix.Output[LookupSystemFortimanagerResult]{
