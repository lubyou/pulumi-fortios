...
func (o LookupFirewallAddressResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupFirewallAddressResult] {
	return pulumix.Output[LookupFirewallAddressResult]{
