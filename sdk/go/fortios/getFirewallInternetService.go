...
func (o LookupFirewallInternetServiceResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupFirewallInternetServiceResult] {
	return pulumix.Output[LookupFirewallInternetServiceResult]{
