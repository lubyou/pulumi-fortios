...
func (o LookupRouterAspathListResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupRouterAspathListResult] {
	return pulumix.Output[LookupRouterAspathListResult]{
