...
func (o LookupFirewallMulticastAddressResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupFirewallMulticastAddressResult] {
	return pulumix.Output[LookupFirewallMulticastAddressResult]{
