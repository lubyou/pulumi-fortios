...
func (o GetRouterAccessListListResultOutput) ToOutput(ctx context.Context) pulumix.Output[GetRouterAccessListListResult] {
	return pulumix.Output[GetRouterAccessListListResult]{
