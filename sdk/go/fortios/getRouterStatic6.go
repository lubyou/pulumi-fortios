...
func (o LookupRouterStatic6ResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupRouterStatic6Result] {
	return pulumix.Output[LookupRouterStatic6Result]{
