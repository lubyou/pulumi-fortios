...
func (o LookupFirewallInternetServiceListResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupFirewallInternetServiceListResult] {
	return pulumix.Output[LookupFirewallInternetServiceListResult]{
