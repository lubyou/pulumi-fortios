...
func (o LookupRouterCommunityListResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupRouterCommunityListResult] {
	return pulumix.Output[LookupRouterCommunityListResult]{
