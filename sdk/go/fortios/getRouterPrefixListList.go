...
func (o GetRouterPrefixListListResultOutput) ToOutput(ctx context.Context) pulumix.Output[GetRouterPrefixListListResult] {
	return pulumix.Output[GetRouterPrefixListListResult]{
