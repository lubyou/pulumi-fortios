...
func (o LookupFirewallAddrgrp6ResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupFirewallAddrgrp6Result] {
	return pulumix.Output[LookupFirewallAddrgrp6Result]{
