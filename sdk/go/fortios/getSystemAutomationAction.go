...
func (o LookupSystemAutomationActionResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupSystemAutomationActionResult] {
	return pulumix.Output[LookupSystemAutomationActionResult]{
