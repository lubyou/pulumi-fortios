...
func (o LookupSystemSitTunnelResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupSystemSitTunnelResult] {
	return pulumix.Output[LookupSystemSitTunnelResult]{
