...
func (o LookupRouterPolicyResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupRouterPolicyResult] {
	return pulumix.Output[LookupRouterPolicyResult]{
