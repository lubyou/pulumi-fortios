...
func (o GetFirewallWildcardFqdnCustomListResultOutput) ToOutput(ctx context.Context) pulumix.Output[GetFirewallWildcardFqdnCustomListResult] {
	return pulumix.Output[GetFirewallWildcardFqdnCustomListResult]{
