...
func (o GetFirewallPolicy64ListResultOutput) ToOutput(ctx context.Context) pulumix.Output[GetFirewallPolicy64ListResult] {
	return pulumix.Output[GetFirewallPolicy64ListResult]{
