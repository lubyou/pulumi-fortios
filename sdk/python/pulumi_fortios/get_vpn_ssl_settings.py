...
__all__ = [
    'GetVpnSslSettingsResult',
    'AwaitableGetVpnSslSettingsResult',
    'get_vpn_ssl_settings',
    'get_vpn_ssl_settings_output',
]

@pulumi.output_type
class GetVpnSslSettingsResult:
    """
    ...
    def authentication_rules(self) -> Sequence['outputs.GetVpnSslSettingsAuthenticationRuleResult']:
    ...
    def source_address6s(self) -> Sequence['outputs.GetVpnSslSettingsSourceAddress6Result']:
    ...
    def source_addresses(self) -> Sequence['outputs.GetVpnSslSettingsSourceAddressResult']:
        return pulumi.get(self, "source_addresses")

    @property
    @pulumi.getter(name="sourceInterfaces")
    def source_interfaces(self) -> Sequence['outputs.GetVpnSslSettingsSourceInterfaceResult']:
    ...
    def tunnel_ip_pools(self) -> Sequence['outputs.GetVpnSslSettingsTunnelIpPoolResult']:
        return pulumi.get(self, "tunnel_ip_pools")

    @property
    @pulumi.getter(name="tunnelIpv6Pools")
    def tunnel_ipv6_pools(self) -> Sequence['outputs.GetVpnSslSettingsTunnelIpv6PoolResult']:
...
class AwaitableGetVpnSslSettingsResult(GetVpnSslSettingsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetVpnSslSettingsResult(
...
def get_vpn_ssl_settings(vdomparam: Optional[str] = None,
                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetVpnSslSettingsResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('fortios:index/getVpnSslSettings:GetVpnSslSettings', __args__, opts=opts, typ=GetVpnSslSettingsResult).value

    return AwaitableGetVpnSslSettingsResult(
...
@_utilities.lift_output_func(get_vpn_ssl_settings)
def get_vpn_ssl_settings_output(vdomparam: Optional[pulumi.Input[Optional[str]]] = None,
                                opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetVpnSslSettingsResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
