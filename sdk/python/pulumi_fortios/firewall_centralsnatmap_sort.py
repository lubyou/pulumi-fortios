...
class _FirewallCentralsnatmapSortState:
    def __init__(__self__, *,
                 ...
                 state_policy_lists: Optional[pulumi.Input[Sequence[pulumi.Input['FirewallCentralsnatmapSortStatePolicyListArgs']]]] = None,
                 status: Optional[pulumi.Input[str]] = None,
                 vdomparam: Optional[pulumi.Input[str]] = None):
        """
    ...
    def state_policy_lists(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['FirewallCentralsnatmapSortStatePolicyListArgs']]]]:
        return pulumi.get(self, "state_policy_lists")

    @state_policy_lists.setter
    def state_policy_lists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['FirewallCentralsnatmapSortStatePolicyListArgs']]]]):
...
class FirewallCentralsnatmapSort(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            sortby: Optional[pulumi.Input[str]] = None,
            sortdirection: Optional[pulumi.Input[str]] = None,
            state_policy_lists: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['FirewallCentralsnatmapSortStatePolicyListArgs']]]]] = None,
            status: Optional[pulumi.Input[str]] = None,
    ...
    @property
    @pulumi.getter(name="statePolicyLists")
    def state_policy_lists(self) -> pulumi.Output[Sequence['outputs.FirewallCentralsnatmapSortStatePolicyList']]:
        return pulumi.get(self, "state_policy_lists")
