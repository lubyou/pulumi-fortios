...
__all__ = ['FirewallPolicySortArgs', 'FirewallPolicySort']

@pulumi.input_type
class FirewallPolicySortArgs:
...
@pulumi.input_type
class _FirewallPolicySortState:
    def __init__(__self__, *,
                 comment: Optional[pulumi.Input[str]] = None,
                 force_recreate: Optional[pulumi.Input[str]] = None,
                 manual_orders: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 ...
                 state_policy_lists: Optional[pulumi.Input[Sequence[pulumi.Input['FirewallPolicySortStatePolicyListArgs']]]] = None,
                 status: Optional[pulumi.Input[str]] = None,
                 vdomparam: Optional[pulumi.Input[str]] = None):
        """
    ...
    def state_policy_lists(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['FirewallPolicySortStatePolicyListArgs']]]]:
        return pulumi.get(self, "state_policy_lists")

    @state_policy_lists.setter
    def state_policy_lists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['FirewallPolicySortStatePolicyListArgs']]]]):
...
class FirewallPolicySort(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a FirewallPolicySort resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: FirewallPolicySortArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a FirewallPolicySort resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param FirewallPolicySortArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(FirewallPolicySortArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = FirewallPolicySortArgs.__new__(FirewallPolicySortArgs)
        ...
        super(FirewallPolicySort, __self__).__init__(
            'fortios:index/firewallPolicySort:FirewallPolicySort',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            sortby: Optional[pulumi.Input[str]] = None,
            sortdirection: Optional[pulumi.Input[str]] = None,
            state_policy_lists: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['FirewallPolicySortStatePolicyListArgs']]]]] = None,
            status: Optional[pulumi.Input[str]] = None,
            vdomparam: Optional[pulumi.Input[str]] = None) -> 'FirewallPolicySort':
        """
        ...
        __props__ = _FirewallPolicySortState.__new__(_FirewallPolicySortState)
        ...
        __props__.__dict__["status"] = status
        __props__.__dict__["vdomparam"] = vdomparam
        return FirewallPolicySort(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="statePolicyLists")
    def state_policy_lists(self) -> pulumi.Output[Sequence['outputs.FirewallPolicySortStatePolicyList']]:
        return pulumi.get(self, "state_policy_lists")
