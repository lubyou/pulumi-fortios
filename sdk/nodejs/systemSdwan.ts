...
export class SystemSdwan extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: SystemSdwanArgs | SystemSdwanState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            inputs["duplicationMaxNum"] = state ? state.duplicationMaxNum : undefined;
            inputs["duplications"] = state ? state.duplications : undefined;
            ...
            inputs["duplicationMaxNum"] = args ? args.duplicationMaxNum : undefined;
            inputs["duplications"] = args ? args.duplications : undefined;
        ...
        super(SystemSdwan.__pulumiType, name, inputs, opts);
    }
}
