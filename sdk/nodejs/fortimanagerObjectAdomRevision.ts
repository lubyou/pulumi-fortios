...
export class FortimanagerObjectAdomRevision extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FortimanagerObjectAdomRevisionState, opts?: pulumi.CustomResourceOptions): FortimanagerObjectAdomRevision {
        return new FortimanagerObjectAdomRevision(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortios:index/fortimanagerObjectAdomRevision:FortimanagerObjectAdomRevision';

    /**
     * Returns true if the given object is an instance of FortimanagerObjectAdomRevision.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is FortimanagerObjectAdomRevision {
    ...
    /**
     * Create a FortimanagerObjectAdomRevision resource with the given unique name, arguments, and options.
     *
