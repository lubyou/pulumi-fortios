...
export class FortimanagerDVMInstallDev extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FortimanagerDVMInstallDevState, opts?: pulumi.CustomResourceOptions): FortimanagerDVMInstallDev {
        return new FortimanagerDVMInstallDev(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortios:index/fortimanagerDVMInstallDev:FortimanagerDVMInstallDev';

    /**
     * Returns true if the given object is an instance of FortimanagerDVMInstallDev.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is FortimanagerDVMInstallDev {
    ...
    /**
     * Create a FortimanagerDVMInstallDev resource with the given unique name, arguments, and options.
     *
