...
export class FortimanagerSystemAdom extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FortimanagerSystemAdomState, opts?: pulumi.CustomResourceOptions): FortimanagerSystemAdom {
        return new FortimanagerSystemAdom(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortios:index/fortimanagerSystemAdom:FortimanagerSystemAdom';

    /**
     * Returns true if the given object is an instance of FortimanagerSystemAdom.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is FortimanagerSystemAdom {
    ...
    /**
     * Create a FortimanagerSystemAdom resource with the given unique name, arguments, and options.
     *
