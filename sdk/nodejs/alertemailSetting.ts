...
export class AlertemailSetting extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: AlertemailSettingArgs | AlertemailSettingState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            inputs["adminLoginLogs"] = state ? state.adminLoginLogs : undefined;
            inputs["alertInterval"] = state ? state.alertInterval : undefined;
            inputs["amcInterfaceBypassMode"] = state ? state.amcInterfaceBypassMode : undefined;
            inputs["antivirusLogs"] = state ? state.antivirusLogs : undefined;
            inputs["configurationChangesLogs"] = state ? state.configurationChangesLogs : undefined;
            inputs["criticalInterval"] = state ? state.criticalInterval : undefined;
            inputs["debugInterval"] = state ? state.debugInterval : undefined;
            inputs["emailInterval"] = state ? state.emailInterval : undefined;
            inputs["emergencyInterval"] = state ? state.emergencyInterval : undefined;
            inputs["errorInterval"] = state ? state.errorInterval : undefined;
            inputs["fdsLicenseExpiringDays"] = state ? state.fdsLicenseExpiringDays : undefined;
            inputs["fdsLicenseExpiringWarning"] = state ? state.fdsLicenseExpiringWarning : undefined;
            inputs["fdsUpdateLogs"] = state ? state.fdsUpdateLogs : undefined;
            inputs["filterMode"] = state ? state.filterMode : undefined;
            inputs["fipsCcErrors"] = state ? state.fipsCcErrors : undefined;
            inputs["firewallAuthenticationFailureLogs"] = state ? state.firewallAuthenticationFailureLogs : undefined;
            inputs["fortiguardLogQuotaWarning"] = state ? state.fortiguardLogQuotaWarning : undefined;
            inputs["fssoDisconnectLogs"] = state ? state.fssoDisconnectLogs : undefined;
            inputs["haLogs"] = state ? state.haLogs : undefined;
            inputs["informationInterval"] = state ? state.informationInterval : undefined;
            inputs["ipsLogs"] = state ? state.ipsLogs : undefined;
            inputs["ipsecErrorsLogs"] = state ? state.ipsecErrorsLogs : undefined;
            inputs["localDiskUsage"] = state ? state.localDiskUsage : undefined;
            inputs["logDiskUsageWarning"] = state ? state.logDiskUsageWarning : undefined;
            inputs["mailto1"] = state ? state.mailto1 : undefined;
            inputs["mailto2"] = state ? state.mailto2 : undefined;
            inputs["mailto3"] = state ? state.mailto3 : undefined;
            inputs["notificationInterval"] = state ? state.notificationInterval : undefined;
            inputs["pppErrorsLogs"] = state ? state.pppErrorsLogs : undefined;
            inputs["severity"] = state ? state.severity : undefined;
            inputs["sshLogs"] = state ? state.sshLogs : undefined;
            inputs["sslvpnAuthenticationErrorsLogs"] = state ? state.sslvpnAuthenticationErrorsLogs : undefined;
            inputs["username"] = state ? state.username : undefined;
            inputs["vdomparam"] = state ? state.vdomparam : undefined;
            inputs["violationTrafficLogs"] = state ? state.violationTrafficLogs : undefined;
            inputs["warningInterval"] = state ? state.warningInterval : undefined;
            inputs["webfilterLogs"] = state ? state.webfilterLogs : undefined;
        } else {
            const args = argsOrState as AlertemailSettingArgs | undefined;
            inputs["adminLoginLogs"] = args ? args.adminLoginLogs : undefined;
            inputs["alertInterval"] = args ? args.alertInterval : undefined;
            inputs["amcInterfaceBypassMode"] = args ? args.amcInterfaceBypassMode : undefined;
            inputs["antivirusLogs"] = args ? args.antivirusLogs : undefined;
            inputs["configurationChangesLogs"] = args ? args.configurationChangesLogs : undefined;
            inputs["criticalInterval"] = args ? args.criticalInterval : undefined;
            inputs["debugInterval"] = args ? args.debugInterval : undefined;
            inputs["emailInterval"] = args ? args.emailInterval : undefined;
            inputs["emergencyInterval"] = args ? args.emergencyInterval : undefined;
            inputs["errorInterval"] = args ? args.errorInterval : undefined;
            inputs["fdsLicenseExpiringDays"] = args ? args.fdsLicenseExpiringDays : undefined;
            inputs["fdsLicenseExpiringWarning"] = args ? args.fdsLicenseExpiringWarning : undefined;
            inputs["fdsUpdateLogs"] = args ? args.fdsUpdateLogs : undefined;
            inputs["filterMode"] = args ? args.filterMode : undefined;
            inputs["fipsCcErrors"] = args ? args.fipsCcErrors : undefined;
            inputs["firewallAuthenticationFailureLogs"] = args ? args.firewallAuthenticationFailureLogs : undefined;
            inputs["fortiguardLogQuotaWarning"] = args ? args.fortiguardLogQuotaWarning : undefined;
            inputs["fssoDisconnectLogs"] = args ? args.fssoDisconnectLogs : undefined;
            inputs["haLogs"] = args ? args.haLogs : undefined;
            inputs["informationInterval"] = args ? args.informationInterval : undefined;
            inputs["ipsLogs"] = args ? args.ipsLogs : undefined;
            inputs["ipsecErrorsLogs"] = args ? args.ipsecErrorsLogs : undefined;
            inputs["localDiskUsage"] = args ? args.localDiskUsage : undefined;
            inputs["logDiskUsageWarning"] = args ? args.logDiskUsageWarning : undefined;
            inputs["mailto1"] = args ? args.mailto1 : undefined;
            inputs["mailto2"] = args ? args.mailto2 : undefined;
            inputs["mailto3"] = args ? args.mailto3 : undefined;
            inputs["notificationInterval"] = args ? args.notificationInterval : undefined;
            inputs["pppErrorsLogs"] = args ? args.pppErrorsLogs : undefined;
            inputs["severity"] = args ? args.severity : undefined;
            inputs["sshLogs"] = args ? args.sshLogs : undefined;
            inputs["sslvpnAuthenticationErrorsLogs"] = args ? args.sslvpnAuthenticationErrorsLogs : undefined;
            inputs["username"] = args ? args.username : undefined;
            inputs["vdomparam"] = args ? args.vdomparam : undefined;
            inputs["violationTrafficLogs"] = args ? args.violationTrafficLogs : undefined;
            inputs["warningInterval"] = args ? args.warningInterval : undefined;
            inputs["webfilterLogs"] = args ? args.webfilterLogs : undefined;
        }
        if (!opts.version) {
            opts = pulumi.mergeOptions(opts, { version: utilities.getVersion()});
        }
        super(AlertemailSetting.__pulumiType, name, inputs, opts);
    }
}
