...
export class FortimanagerSystemSyslogServer extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FortimanagerSystemSyslogServerState, opts?: pulumi.CustomResourceOptions): FortimanagerSystemSyslogServer {
        return new FortimanagerSystemSyslogServer(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'fortios:index/fortimanagerSystemSyslogServer:FortimanagerSystemSyslogServer';

    /**
     * Returns true if the given object is an instance of FortimanagerSystemSyslogServer.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is FortimanagerSystemSyslogServer {
    ...
    /**
     * Create a FortimanagerSystemSyslogServer resource with the given unique name, arguments, and options.
     *
