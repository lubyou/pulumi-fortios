...
export class VpnIpsecPhase2 extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: VpnIpsecPhase2Args | VpnIpsecPhase2State, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            inputs["selectorMatch"] = state ? state.selectorMatch : undefined;
            ...
            inputs["useNatip"] = state ? state.useNatip : undefined;
            ...
            inputs["selectorMatch"] = args ? args.selectorMatch : undefined;
            ...
            inputs["useNatip"] = args ? args.useNatip : undefined;
            inputs["vdomparam"] = args ? args.vdomparam : undefined;
        }
        if (!opts.version) {
            opts = pulumi.mergeOptions(opts, { version: utilities.getVersion()});
        }
        super(VpnIpsecPhase2.__pulumiType, name, inputs, opts);
    }
}
